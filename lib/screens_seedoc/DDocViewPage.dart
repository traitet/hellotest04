  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(icon: Icon(Icons.camera_alt), onPressed: (){fnScan(context);})
        ],
      ),
      //===============================================================================
      // BUTTOM NAVIGATE BAR
...
void fnRecall(BuildContext context, String myDocId) {
      showMessageBox(context, "success", "Recall Document($myDocId) to Firestore Database completely", actions: [dismissButton(context)]);
